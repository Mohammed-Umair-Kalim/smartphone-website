        ...
        <div>
          <div className="border border-gray-200 rounded p-6">
            ...
            <div className="flex justify-between mb-3">
              <span>Huawei Mate XT Ultimate x 1</span>
              <span className="font-medium">$ 2800.00</span>
            </div>
            
            <div className="flex justify-between mb-3">
              <span>Samsung Z Fold 5 x 1</span>
              <span className="font-medium">$ 1400.00</span>
            </div>
            
            <div className="flex justify-between mb-3">
              <span>Motorolla Razr 40 Ultra x 1</span>
            ...
            <div className="flex justify-between font-bold text-lg mb-6">
              <span>Total</span>
              <span className="text-yellow-600">$ 4900.00</span>
            </div>
